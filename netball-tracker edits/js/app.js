...
function setScreenDisplay(id, display) {
...
function goHome() {
  ...
  setScreenDisplay("game", "none");
  setScreenDisplay("newGameScreen", "none");
  setScreenDisplay("statsScreen", "none");
  setScreenDisplay("demoScreen", "none");
  setScreenDisplay("positionModal", "none");
  setScreenDisplay("home", "block");
